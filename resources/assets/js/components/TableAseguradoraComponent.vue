        ...
        <tbody>
          <tr v-for="aseguradora in aseguradoras" :key="aseguradora.codigo">
            ...
            <td style="text-align: right;">
				<a class="button is-link is-rounded is-outlined" :href="'/aseguradora/' + aseguradora.codigo + '/editar'">Editar</a>
				<a class="button is-link is-rounded is-outlined" id="BtnDelAseg" :attr-id="aseguradora.codigo" >Eliminar</a>
			</td>
          </tr>
        </tbody>
      </table> 
