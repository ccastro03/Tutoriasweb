        ...
        <tbody>
          <tr v-for="especialidad in especialidades" :key="especialidad.codigo">
            ...
            <td style="text-align: right;">
				<a class="button is-link is-rounded is-outlined" :href="'/especialidades/' + especialidad.codigo + '/editar'">Editar</a>
				<a class="button is-link is-rounded is-outlined" id="BtnDelEspe" :attr-id="especialidad.codigo" >Eliminar</a>
			</td>
          </tr>
        </tbody>
      </table> 
