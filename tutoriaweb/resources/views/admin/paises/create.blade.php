...
<div class="column is-12">
  <div class="panel">
    <p class="panel-heading">Creación de paises</p>
    <div class="panel-block">
      <form class="long-form" action="{{ url('paises') }}" method="post">
        @csrf
        @if(count($errors) > 0)
        ...
        <a href="{{ url('paises') }}" class="button is-medium is-link is-outlined">Salir</a>
      </form>      
    </div>   
  </div>
</div>  
